...
export const mockAiCardList: AiCardItem[] = [
  {
    ...
    // 슬픔 -> 유쾌/힐링으로 환기
    subtitle:
      "요즘 마음이 많이 무거우셨군요. 기분 전환이 될 유쾌하고 따뜻한 작품들을 준비했어요.",
  ...
  },
  {
    ...
    // 공포 -> 유쾌/힐링으로 환기
    subtitle:
      "긴장되고 불안한 하루였나요? 마음이 편안해질 따뜻한 작품들을 골라봤어요.",
    recommendedMediaList: [
  ...
  },
  {
    ...
    // 유쾌 -> 설렘 환기
    subtitle:
      "요즘 배꼽 빠지는 유쾌한 작품만 연달아 보셨네요! 지금은 심장 몽글몽글해지는 로맨스로 감성을 충전해보는 건 어떨까요?",
    recommendedMediaList: [
  ...
  },
  {
    ...
    // 힐링 -> 도파민/자극으로 환기
    subtitle:
      "너무 잔잔한 것들만 보셨네요. 이번엔 짜릿하고 강렬한 작품으로 활력을 충전해보세요!",
    recommendedMediaList: [
  ...
  },
  {
    ...
    // 설렘 -> 공포 환기
    subtitle:
      "설레는 로맨스에 푹 빠져 계셨군요! 이번엔 심장이 쫄깃해지는 스릴 넘치는 작품들로 색다른 두근거림을 느껴보세요.",
    recommendedMediaList: [
      {
        mediaId: 501,
  ...
  },
  {
    ...
    // 지식 -> 유쾌로 환기
    subtitle:
      "머리를 많이 쓰셨네요! 이번엔 아무 생각 없이 즐길 수 있는 가벼운 작품들을 추천해드려요.",
    recommendedMediaList: [
      {
        mediaId: 601,
        posterUrl: "/images/poster16.jpg",
        mediaType: "CONTENTS",
      },
      {
        mediaId: 602,
        posterUrl: "/images/poster17.jpg",
        mediaType: "CONTENTS",
      },
  ...
  },
  {
    ...
    // 자극 -> 힐링으로 환기
    subtitle:
      "강렬한 것들만 연달아 보셨네요. 잠깐 쉬어가며 따뜻하고 잔잔한 작품들은 어떠세요?",
    recommendedMediaList: [
  ...
  },
  {
    ...
    subtitle:
      "요즘 비슷한 분위기의 작품들만 연달아 보셨네요! 이번엔 완전히 새로운 짜릿함을 느껴보세요.",
    recommendedMediaList: [
...
export const mockActiveAiCard: AiCardItem | null = mockAiCardList[6];
