...
import { RecentItem } from "@/mocks/mockRecent";
      ...
      <div ref={scrollRef} className="flex gap-15 pt-5 pb-5 overflow-x-auto no-scrollbar">
        {items.map((item) => (
          <div key={item.id} className="shrink-0">
            ...
            <div className="w-80 h-60 flex items-center justify-center bg-ot-gray-800 rounded-lg overflow-hidden border border-ot-gray-700">
