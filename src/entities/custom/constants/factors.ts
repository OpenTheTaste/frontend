export type Factor = '대중성' | '몰입도' | '마니아' | '최신성' | '숏폼 트렌드' | '내 취향';

export const FACTORS: Factor[] = ['대중성', '몰입도', '마니아', '최신성', '숏폼 트렌드', '내 취향'];
...
export const GENRES = ['인기작 위주', '숨은 명작', '내 취향', '초기화'];
...
export const GUIDE_ITEMS: { key: Factor; en: string; desc: string }[] = [
  ...
  },
  {
    key: '내 취향',
    en: 'Tag Match',
    desc: '내가 평소 즐겨 보던 장르와 태그를 분석해 가장 높은 일치율을 보이는 작품을 보여줍니다.',
  },
];
