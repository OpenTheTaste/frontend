    ...
    <div className="bg-ot-background rounded-lg">
      ...
      >
        <div className="flex items-center gap-2 mb-2">
          <div className="flex items-center gap-1 px-2 py-1 bg-ot-primary-500 rounded text-ot-text text-xs font-bold">
            <Link size={12} />
            <span>원본</span>
          </div>
        </div>

        <h3 className="text-ot-text font-bold text-xs mb-2 line-clamp-2">
          {contentLink.title}
        </h3>
