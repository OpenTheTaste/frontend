  ...
  return (
    <section className="w-full bg-ot-background">
      <div className="px-6 py-6 max-w-2xl mx-auto">
        <h2 className="text-xl font-bold text-ot-text mb-6">자주 묻는 질문</h2>
        {faqs.map((faq, idx) => (
